  ...
  return {
    ...
    data: {
      ...
      meetings: response.data.meetings.map<Session>((meeting) => ({
        ...
        standardWebcast: meeting.standard_webcast,
        premiumWebcast: meeting.premium_webcast,
        youtube: {
          required: meeting.youtube_required,
          watchUrl: meeting.youtube_watch_url,
          ingestUrls: meeting.youtube_ingest_urls,
          streamKey: meeting.youtube_stream_key,
        },
